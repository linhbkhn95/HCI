...
import TableBootstrap from './components/TableBrowse.js';
    ...
    render(){
        return(
            ...
            <div className="panel panel-default">
             <div  style={{ borderBottom: "1px solid rgba(156, 164, 179, 0.24)"}}><div  className="col-md-6 col-xs-12 title-content">Đuyệt Công tác phí</div></div>
      
               <div className="panel-body">
                    <div className="browser-work">
                       <div className="rows col-md-12"><TableBootstrap /></div>
                    </div>
